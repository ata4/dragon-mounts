...
public class DragonControl {
    ...
    private final DragonControlChannelHandler channel;
    
    public DragonControl(DragonControlChannelHandler channel) {
    ...
    public void onTick(ClientTickEvent evt) {
        ...
        // send message to server if it changed
        if (dcm.hasChanged()) {
            channel.sendToServer(dcm);
        }
    }
}
