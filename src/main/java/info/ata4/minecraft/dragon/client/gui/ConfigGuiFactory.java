...
public class ConfigGuiFactory implements IModGuiFactory
{
	...
	public static class DragonMountConfigGui extends GuiConfig
	{
		...
		private static List<IConfigElement> getConfigElements()
		{
			...
			list.add(new DummyCategoryElement("category_options", "gui.config.category.options", CategoryEntryOptions.class));
			list.add(new DummyCategoryElement("category_debug", "gui.config.category.debug", CategoryEntryDebug.class));
			return list;
		}
		
		//the next two classes are the edit screens for each configuration category
		public static class CategoryEntryOptions extends CategoryEntry
		{
			public CategoryEntryOptions(GuiConfig owningScreen, GuiConfigEntries owningEntryList, IConfigElement prop)
			{
		...
		public static class CategoryEntryDebug extends CategoryEntry
		{
			public CategoryEntryDebug(GuiConfig owningScreen, GuiConfigEntries owningEntryList, IConfigElement prop)
			{
				super(owningScreen, owningEntryList, prop);
			}
